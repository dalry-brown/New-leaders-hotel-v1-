...
const HaveLogin = () => {
      ...
      >
        <div style={{display: signInStateObj.checkDisplay}}>
          ...
          <div className={ bookingStyle.proceedToConfirm }>
            <h3 className={bookingStyle.signInSuccess}>Sign In Successful</h3>
  ...
  <h2 className={bookingStyle.sectionTitle}>
    To continue Booking <Link style={{
      color: '#3B0908',
      fontSize: '14px',
      fontStyle: 'normal',
      fontWeight: 500,
      ...
      to='/login'><br/>Sign In</Link>  or <Link style={{
        color: '#3B0908',
        fontSize: '14px',
        fontStyle: 'normal',
        fontWeight: 500,
    ...
    <section className={bookingStyle.section2}>
      ...
      >
        <div style={{ display: bookingStateObj.checkDisplay }}>
          ...
          <div className={ bookingStyle.proceedToConfirm }>
            <h3 className={bookingStyle.signInSuccess}>Booking Successful</h3>
            <div className={ bookingStyle.proceed }>
        ...
        <p className={bookingStyle.optionsTitle}>Kindly select your preferred payment method:</p><br />
          <div className={bookingStyle.paymentOptions}>
            <div className={bookingStyle.option1}>
              <div style={{backgroundColor: '#FFC107', border: '2px solid #FFC107'}} className={bookingStyle.optionCircle}></div>
              <p>You can either pay securely online now</p>
            </div>
            <div className={bookingStyle.option1}>
              <div style={{backgroundColor: '#3B0908', border: '2px solid #3B0908'}} className={bookingStyle.optionCircle}></div>
              <p>or opt to pay at the hotel upon arrival.</p> 
            </div>
        </div>
      </div>
      <div className={bookingStyle.btns}>
      <button className={bookingStyle.purchaseBtn}><Link style={{ fontWeight: '600', color: "#3B0908",textDecoration: 'none', width: '100%' }} to='#'>Pay Online</Link></button>
